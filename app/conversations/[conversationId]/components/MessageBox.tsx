    ...
    <div className={container}>
      ...
      <div className={body}>
        ...
        <div className={message}>
          {data.image ? <Image alt="Image" height={290} width={290} src={data.image} className="object-cover cursor-pointer hover:scale-110 transition translate" /> : <div>{data.body}</div>}
        </div>
